//package com.wode.bangertongadmin.monitor;//package com.wode.bangertong.monitor;
//
...
//import com.wode.bangertong.common.exception.NoPermissionException;
//import com.wode.bangertong.common.exception.PermissionException;
//import com.wode.bangertong.common.model.Result;
//import com.wode.bangertong.common.utils.JsonUtil;
...
//
//    @Pointcut("execution(* com.wode.bangertongadmin.controller..*(..)) ")
...
//        SysUser user = (SysUser) redisTemplate.opsForValue().get(RedisContants.SYS_USER_TOKEN + token);
//
////        验证是否登录
//        if((null == token || null == user) && !url.equals("/bangertong-admin/sysUser/api/login")){
